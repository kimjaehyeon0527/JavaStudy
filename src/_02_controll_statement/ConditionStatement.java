...
//        Why?
//        - '==' 연산자 : 두 객체의 참조를 비교. (동일한 메모리 위치 가르키는지 확인) (주소 비교)
...
//        str1, str2 같은 경우에 같은 문자열을 가리키고 있으므로 같은 참조값을 가진다.
        String str1 = "hello";
        String str2 = "hello";
...
//        따라서 문자열 비교시 (내용) 기본적으로 '.equals()' 메소드로 비교하는 것이 좋다.
        ...
        ////////////////////////////////////
//        switch ~ case 문
//        - 각 case 문의 break 문으로 선택 사항, break 문 생략시 바로 밑의 case 문으로 넘어간다.
        String dayOfWeek;
        int day = 4;
