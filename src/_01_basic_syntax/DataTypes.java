...
//        정수형 변수 선언
        int x = 10;
        long y = 10000000L; // long 타입은 뒤에 'l, L'를 붙여야 한다.
        short z = 3545;
        byte b = 123;

//        실수형 변수 선언
        float a = 3.14f; // float 타입은 뒤에 'f, F'를 붙여야 한다.
        double c = 2.421;
...
//        - Java 에서 Stirng 타입은 특별함. 참조형이지만, 기본형 처럼 사용한다. (불변 객체)
...
//        nums 배열을 num으로 출력
        ...
        System.out.println();
        System.out.println("Person 클랙스 객체 : " + person.getName() + ", " + person.getAge());
    }
}
...
//    java는 강한 타입이기 때문에 함수에도 명확한 타입 선언해줄 것.
